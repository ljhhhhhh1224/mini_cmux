...
type HelloGRPCClient interface {
	...
	RequestStop(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error)
}
...
func (c *helloGRPCClient) SayHi(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, "/grpc.HelloGRPC/SayHi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloGRPCClient) RequestStop(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, "/grpc.HelloGRPC/RequestStop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloGRPCServer interface {
	...
	RequestStop(context.Context, *Req) (*Res, error)
...
func (UnimplementedHelloGRPCServer) RequestStop(context.Context, *Req) (*Res, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestStop not implemented")
}
...
func _HelloGRPC_SayHi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.HelloGRPC/SayHi",
	}
...
func _HelloGRPC_RequestStop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Req)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloGRPCServer).RequestStop(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.HelloGRPC/RequestStop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloGRPCServer).RequestStop(ctx, req.(*Req))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HelloGRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RequestStop",
			Handler:    _HelloGRPC_RequestStop_Handler,
		},
	},
